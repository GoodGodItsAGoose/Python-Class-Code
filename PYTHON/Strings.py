...
class mainWindow(object):
    def __init__(self,master):
        ...
        self.l.pack()
        self.e=tk.Entry(master)# put in numbers, then it spits out answer?
        self.e.pack()
...
#trying to get command to print answer, need answer to be gotten and changed to a variable, then print that variable, but the print(variable) needs to be before mainWindow
    def solve(self):
        string_two = int(self.e.get())# WHERE IS int() with base 10:'16/7' WHY YOU NO WORK AAAAAAAAAAAAAAA
        print(string_two)
    ...
    def new_method(self):
        return self.w.value # should go to answer of solve and __init__, why __init__? just go to solve and get answer of solve, then print answer of solve.
